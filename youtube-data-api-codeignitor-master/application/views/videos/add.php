...
<section class="content">
    ...
    <div class="box box-primary">
      <form id="upload_form" enctype="multipart/form-data" method="post" action="<?= CUSTOM_BASE_URL . 'youtube/create' ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      <label>Tags</label>
                      <input type="text" name="tag" class="form-control" value="<?php echo set_value('tag'); ?>">
...
window.location = '<?= CUSTOM_BASE_URL . "student_reg" ?>';
});
