...
class Google_client_api {
	...
	public function youtube_upload($video,$title,$desc,$tags,$privacy_status) {
	...
	//	echo "1";exit;
		...
		if ($client->getAccessToken()) {
		  ...
		  try{
			...
			$videoPath = $_SERVER["DOCUMENT_ROOT"] . "/my/videos/".$video;
			//print_r($videoPath);exit;
			//$videoPath = "http://onlister.in/psc/admin/videos/sample.mp4";
