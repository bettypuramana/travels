...
<html>
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>AdminLTE 2 |PSC Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
          <!--<a  href="../../index2.html"><img style="display:block;margin:10px auto;max-width: 180px;"" src="<?= CUSTOM_BASE_URL.'assets/dist/img/lakshya_logo.png'?>" class="log-log13" alt=""></a>-->
