                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="form-group">
                                            ...
                                            <select name="role" class="selectpicker form-control">
                                                   ...
                                                   <option value="user" <?= (set_value('user') != '') ? set_select('user', 'user') : ($row['role'] == 'user') ? "selected='selected'" : '' ?> >User</option>
                                                   
                                                   <!--<option value="employee" <?= (set_value('employee') != '') ? set_select('employee', 'employee') : ($row['role'] == 'employee') ? "selected='selected'" : '' ?> >Employee</option>-->
