                                    ...
                                    <?php foreach ($list as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <a class="btn btn-warning" href="<?= CUSTOM_BASE_URL.'Admin/Booking/edit/'.$row->id;?>"><i class="fa fa-eye" aria-hidden="true"></i></a>

                                            <a href="<?= base_url('Admin/Booking/delete/' . $row->id) ?>" class="btn btn-danger delete-btn" onclick="return confirm('Are you sure you want to delete this record?');">
