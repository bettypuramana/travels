...
?>
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                                 ...
                                 <form id="form" role="form" action="<?= CUSTOM_BASE_URL . 'Admin/Tour/store' ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="theme" value="<?php echo set_value('theme'); ?>">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="deptfrom" value="<?php echo set_value('deptfrom'); ?>">
                                      ...
                                      <div class="col-md-6">
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="person" value="<?php echo set_value('person'); ?>">
