              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="table">
                                    ...
                                    <?php foreach ($list as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?= CUSTOM_BASE_URL.'uploads/tour/'.$row->image;?>" alt="tour image" class="img-fluid" height="100"></td>
                                            <td><?= $row->person; ?></td>
                                            
                                            <td>

                                               <a class="btn btn-warning" href="<?= CUSTOM_BASE_URL.'Admin/Tour/edit/'.$row->tour_id;?>"><i class="fa fa-edit" aria-hidden="true"></i></a>

                                            <a href="<?= base_url('Admin/Tour/delete/' . $row->tour_id) ?>" class="btn btn-danger delete-btn" onclick="return confirm('Are you sure you want to delete this record?');">
