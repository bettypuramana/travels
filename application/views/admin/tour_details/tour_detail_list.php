                                    ...
                                    <?php foreach ($list as $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <a class="btn btn-warning" href="<?= CUSTOM_BASE_URL.'Admin/Tour_Details/tour_detail_edit/'.$row->tour_id;?>"><i class="fa fa-edit" aria-hidden="true"></i></a>

                                            <a href="<?= base_url('Admin/Tour_Details/tour_detail_delete/' . $row->tour_id) ?>" class="btn btn-danger delete-btn" onclick="return confirm('Are you sure you want to delete this record?');">
