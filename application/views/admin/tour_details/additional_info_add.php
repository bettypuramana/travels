...
?>
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                                 ...
                                 <form id="form" role="form" action="<?= CUSTOM_BASE_URL . 'Admin/Tour_Details/store_additional_info' ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row"> 
                                       <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" name="tour_detail" value="<?php echo set_value('tour_detail'); ?>"></textarea>
