...
class User_model extends MY_Model  //extend MY_model from CI_model in core
{
    ...
    public function getProfile($id='') //get all data from user table
    {
        ...
        $session_data=$this->session->userdata('rankfordAdminDetails');
        $username=$session_data->username;
        
        $this->db->select('id,role,mobile,username,email');
        $this->db->from('users');
    ...
    // public function updateComplaint($id, $val) //change password
    // {
