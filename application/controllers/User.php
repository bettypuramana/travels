...
{ 
  ...
  public function index() {
    //print_r($this->model->getProfile());exit;
  ...
  public function updatepassword()  {
    ...
    if ($this->form_validation->run() == FALSE) 
    {
      ...
      $this->model->changePasswordDet($hash, $this->rankfordAdminDetails->id);
  ...
  public function currentPasswordCheck($currentPassword) {
    ...
    if (!$this->bcrypt->check_password($currentPassword, $this->rankfordAdminDetails->password) )
    {
  ...
  public function update_profile() {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $this->model->updateProfileDet($value,$this->rankfordAdminDetails->id);
    ...
    //         $ticket_id = "AJTK-".$obj['id'];
            
    //         $val = array('ticket_id'=>$ticket_id);
            
    //         $this->model->updateComplaint($obj['id'],$val);
