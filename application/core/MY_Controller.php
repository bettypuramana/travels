...
public function __construct() {
    ...
    $this->rankfordAdminDetails = $this->session->userdata('rankfordAdminDetails');
   ...
   public function loadView($contentPage, $data = array()) {
        ...
        $this->data['rankfordAdminDetails'] = $this->rankfordAdminDetails;
   ...
   public function update() {
        ...
        if ($row->user_id != $this->rankfordAdminDetails->id) {
...
public function is_logged_in() {
    ...
    $user = $this->session->userdata('rankfordAdminDetails');
