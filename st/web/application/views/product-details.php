            ...
            <div class="row">
             ...
             <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 amt-deta12">
              <div class="prd-pri-out">
                  <div class="prd-p"><i class="glyph-icon flaticon-rupee-indian"></i> <span><?= $row['list_price']; ?></span></div>
              </div>
              <div class="prd-pri-out">
                <div class="prd-p-rgt">
                 <div class="prd-p-n"><i class="glyph-icon flaticon-rupee-indian"></i> <span><?= $row['price']; ?></span></div>
            ...
            <div class="item">
             <div class="on-out-pro">   
              <div class="on-out-pro-img snip1252"> 
                  <a href="<?= CUSTOM_BASE_URL . 'product-details/'.$mackratt; ?>" target="_blank"><img src="<?= CUSTOM_BASE_URL . 'admin/uploads/product_multimage/'.$similar_rows['image_name']; ?>" alt="banglure bazaar"></a>
              </div>
              <a class="on-pro-ou-ab" href="#">
               <h1 class="on-pro-hd-a"><?= $similar_rows['stock_name']; ?></h1>
               <h2 class="on-pro-hd-b"><?= $similar_rows['discount']; ?>% OFF</h2>
              </a>
               <div class="on-sh-out"> 
                <div class="pro-price">
                 <span class="pro-rup"><i class="glyph-icon flaticon-rupee-indian"></i></span><span class="pro-price-in"><?= $similar_rows['list_price']; ?></span> 
                </div>
               </div>   
             </div>
            </div>
